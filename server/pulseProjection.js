...
export function projectMission(m, names) {
	return {
		...
		finding_count: m.findingsCount ?? 0,
		finding_snapshot_count: m.findingsSnapshotCount ?? null,
		finding_count_semantics: m.findingCountSemantics ?? null,
		execution_outcome: m.executionOutcome ?? null,
		outcome_reason: m.outcomeReason ?? null,
		report_available: m.reportAvailable ?? false,
...
export function projectSessionSummary(s, names) {
	return {
		...
		finding_snapshot_count: s.findingSnapshotCount ?? null,
		finding_count_semantics: s.findingCountSemantics ?? null,
		execution_outcome: s.executionOutcome ?? null,
		outcome_reason: s.outcomeReason ?? null,
		report_available: s.reportAvailable ?? false,
...
export function projectSessionDetail(s, names, live) {
	return {
		...
		finding_count: s.findingCount ?? count(s.findings),
		finding_snapshot_count: s.findingSnapshotCount ?? null,
		finding_count_semantics: s.findingCountSemantics ?? null,
		execution_outcome: s.executionOutcome ?? null,
		outcome_reason: s.outcomeReason ?? null,
